...
func TestJSONEncoder(t *testing.T) {
	o := tools.OrderedMapFromKVArray(tools.Slice[*orderedmap.Pair]{
		...
		orderedmap.NewPair("object", tools.OrderedMapFromKVArray(tools.Slice[*orderedmap.Pair]{
			...
			orderedmap.NewPair("contentMap", tools.OrderedMapFromKVArray(tools.Slice[*orderedmap.Pair]{
			...
			orderedmap.NewPair("replies", tools.OrderedMapFromKVArray(tools.Slice[*orderedmap.Pair]{
				...
				orderedmap.NewPair("first", tools.OrderedMapFromKVArray(tools.Slice[*orderedmap.Pair]{
